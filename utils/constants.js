module.exports = {
  ...
  YOUTUBE_REGEX: /(?:https?:\/\/)?(?:www\.)?(?:youtube\.com|youtu\.be)\/(watch\?v=|embed\/|v\/|watch\?feature=player_embedded&v=|watch\?feature=player_embedded&v=|youtu.be\/|user\/\S+\/|playlist\?list=)([\w-]+)/,
